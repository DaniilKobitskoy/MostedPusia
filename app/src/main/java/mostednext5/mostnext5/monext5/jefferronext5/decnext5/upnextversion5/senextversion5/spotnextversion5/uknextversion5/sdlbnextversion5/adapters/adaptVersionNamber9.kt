...
import mostednext5.mostnext5.monext5.jefferronext5.decnext5.upnextversion5.senextversion5.spotnextversion5.uknextversion5.sdlbnextversion5.fragments.layout_number1_fragment
import mostednext5.jecaa.most.fragments.layout_number2_fragment


class adaptVersionNamber9 (var arraymostedversion6: ArrayList<Fragment>, fragmentManageradaptersVersions6: FragmentManager)
    ...
    override fun getItem(posadapterversion6: Int): Fragment {
        return when (posadapterversion6) {
            0 -> layout_number1_fragment()
            1 -> layout_number2_fragment()
            else -> layout_number1_fragment()
